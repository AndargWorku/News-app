...
type Props = {
    onChategoryChanged: (category: string)=>void;
};

const Categories = ({onChategoryChanged}: Props) => {
  ...
  const handleSelectCategory=(index:number)=>{
    ...
    onChategoryChanged(newsCategoryList[index].slug)
  };
  ...
  return (
    <View>
      <Text style={styles.title}> Trading Right now</Text>
      <ScrollView
        ref={scrollRef}
        horizontal
